...
@dso_cache = dso_local local_unnamed_addr global [60 x %struct.DSOCacheEntry] [
	%struct.DSOCacheEntry {
		...
		ptr @.DSOCacheEntry.4_name, ; name: libc++_shared.so
	...
	%struct.DSOCacheEntry {
		...
		ptr @.DSOCacheEntry.8_name, ; name: libSystem.Security.Cryptography.Native.Android.so
		ptr null; void* handle
	}, ; 1
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.11_name, ; name: libmono-component-marshal-ilgen.so
		ptr null; void* handle
	}, ; 3
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.5_name, ; name: libSystem.Globalization.Native.so
		ptr null; void* handle
	}, ; 4
	%struct.DSOCacheEntry {
		i64 u0x174f06c23659f8cc, ; from name: il2cpp.so
		i64 u0x30048d0bb36d7ffe, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 true, ; bool is_jni_library
		ptr @.DSOCacheEntry.2_name, ; name: libil2cpp.so
		ptr null; void* handle
	}, ; 5
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.12_name, ; name: libmonosgen-2.0.so
		ptr null; void* handle
	}, ; 6
	%struct.DSOCacheEntry {
		i64 u0x1bcab89803e85150, ; from name: libunity.so
		i64 u0x1bcab89803e85150, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 true, ; bool is_jni_library
		ptr @.DSOCacheEntry.3_name, ; name: libunity.so
		ptr null; void* handle
	}, ; 7
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 true, ; bool is_jni_library
		ptr @.DSOCacheEntry.14_name, ; name: libxamarin-debug-app-helper.so
		ptr null; void* handle
	}, ; 8
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 true, ; bool is_jni_library
		ptr @.DSOCacheEntry.13_name, ; name: libmonodroid.so
		ptr null; void* handle
	}, ; 10
	%struct.DSOCacheEntry {
		i64 u0x30048d0bb36d7ffe, ; from name: libil2cpp.so
		i64 u0x30048d0bb36d7ffe, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 true, ; bool is_jni_library
		ptr @.DSOCacheEntry.2_name, ; name: libil2cpp.so
	...
	%struct.DSOCacheEntry {
		i64 u0x39171906403876ce, ; from name: swappywrapper.so
		i64 u0x61f6e3f531272d8c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.0_name, ; name: libswappywrapper.so
		ptr null; void* handle
	}, ; 13
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.6_name, ; name: libSystem.IO.Compression.Native.so
		ptr null; void* handle
	}, ; 14
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.10_name, ; name: libmono-component-hot_reload.so
		ptr null; void* handle
	}, ; 17
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.7_name, ; name: libSystem.Native.so
		ptr null; void* handle
	}, ; 20
	%struct.DSOCacheEntry {
		i64 u0x5ce5042a251a057e, ; from name: swappywrapper
		i64 u0x61f6e3f531272d8c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.0_name, ; name: libswappywrapper.so
	...
	%struct.DSOCacheEntry {
		i64 u0x61f6e3f531272d8c, ; from name: libswappywrapper.so
		i64 u0x61f6e3f531272d8c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.0_name, ; name: libswappywrapper.so
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.9_name, ; name: libmono-component-debugger.so
		ptr null; void* handle
	}, ; 26
	%struct.DSOCacheEntry {
		i64 u0x710fbd15fc57fd1f, ; from name: libunity
		i64 u0x1bcab89803e85150, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 true, ; bool is_jni_library
		ptr @.DSOCacheEntry.3_name, ; name: libunity.so
	...
	%struct.DSOCacheEntry {
		i64 u0x75818bd57b009d92, ; from name: unity.so
		i64 u0x1bcab89803e85150, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 true, ; bool is_jni_library
		ptr @.DSOCacheEntry.3_name, ; name: libunity.so
	...
	%struct.DSOCacheEntry {
		i64 u0x7e4764b6a46cefcc, ; from name: libswappywrapper
		i64 u0x61f6e3f531272d8c, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.0_name, ; name: libswappywrapper.so
	...
	%struct.DSOCacheEntry {
		i64 u0x881d84ad3ac538a4, ; from name: il2cpp
		i64 u0x30048d0bb36d7ffe, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 true, ; bool is_jni_library
		ptr @.DSOCacheEntry.2_name, ; name: libil2cpp.so
	...
	%struct.DSOCacheEntry {
		i64 u0xd27dd42c7105f824, ; from name: unity
		i64 u0x1bcab89803e85150, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 true, ; bool is_jni_library
		ptr @.DSOCacheEntry.3_name, ; name: libunity.so
	...
	%struct.DSOCacheEntry {
		i64 u0xfb5759de22176798, ; from name: libil2cpp
		i64 u0x30048d0bb36d7ffe, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 true, ; bool is_jni_library
		ptr @.DSOCacheEntry.2_name, ; name: libil2cpp.so
...
@dso_jni_preloads_idx_count = dso_local local_unnamed_addr constant i64 20, align 8

; Indices into dso_cache[] of DSO libraries to preload because of JNI use
@dso_jni_preloads_idx = dso_local local_unnamed_addr constant [20 x i32] [
	i32 22, ; libmain.so
	i32 37, ; libmain
	i32 55, ; main.so
	i32 19, ; main
...
;DSOCacheEntry
@.DSOCacheEntry.0_name = private unnamed_addr constant [20 x i8] c"libswappywrapper.so\00", align 1
@.DSOCacheEntry.1_name = private unnamed_addr constant [11 x i8] c"libmain.so\00", align 1
@.DSOCacheEntry.2_name = private unnamed_addr constant [13 x i8] c"libil2cpp.so\00", align 1
@.DSOCacheEntry.3_name = private unnamed_addr constant [12 x i8] c"libunity.so\00", align 1
@.DSOCacheEntry.4_name = private unnamed_addr constant [17 x i8] c"libc++_shared.so\00", align 1
@.DSOCacheEntry.5_name = private unnamed_addr constant [34 x i8] c"libSystem.Globalization.Native.so\00", align 1
@.DSOCacheEntry.6_name = private unnamed_addr constant [35 x i8] c"libSystem.IO.Compression.Native.so\00", align 1
@.DSOCacheEntry.7_name = private unnamed_addr constant [20 x i8] c"libSystem.Native.so\00", align 1
@.DSOCacheEntry.8_name = private unnamed_addr constant [50 x i8] c"libSystem.Security.Cryptography.Native.Android.so\00", align 1
@.DSOCacheEntry.9_name = private unnamed_addr constant [30 x i8] c"libmono-component-debugger.so\00", align 1
@.DSOCacheEntry.10_name = private unnamed_addr constant [32 x i8] c"libmono-component-hot_reload.so\00", align 1
@.DSOCacheEntry.11_name = private unnamed_addr constant [35 x i8] c"libmono-component-marshal-ilgen.so\00", align 1
@.DSOCacheEntry.12_name = private unnamed_addr constant [19 x i8] c"libmonosgen-2.0.so\00", align 1
@.DSOCacheEntry.13_name = private unnamed_addr constant [16 x i8] c"libmonodroid.so\00", align 1
@.DSOCacheEntry.14_name = private unnamed_addr constant [31 x i8] c"libxamarin-debug-app-helper.so\00", align 1
